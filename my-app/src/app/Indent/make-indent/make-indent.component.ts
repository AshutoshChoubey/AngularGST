...
@Component({
  selector: 'app-make-indent',
  templateUrl: './make-indent.component.html',
  styleUrls: ['./make-indent.component.css']
})
export class MakeIndentComponent implements OnInit {
  ...
  this.validation=0;
     ...
     for(let stock of this.mainArray){
      ...
      // console.log("ft");
       ...
       if(stock.quantity==''|| typeof(stock.quantity) == "undefined"  || typeof(stock.purpose) == "undefined" || typeof(stock.purpose) == "undefined" || stock.remark=='' || stock.remark=='')
        {
         this.validation=1;
        }
